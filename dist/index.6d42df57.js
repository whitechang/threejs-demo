...
(function() {
    var BACK, COPLANAR, EPSILON, FRONT, SPANNING, returning, __bind = function(fn, me) {
        return function() {
    ...
    window.ThreeBSP = function() {
        function ThreeBSP1(treeIsh, matrix) {
            this.matrix = matrix;
        ...
        ThreeBSP1.prototype.toTree = function(treeIsh) {
            var face, geometry, i, polygons, _fn, _i, _len, _ref, _this = this;
            if (treeIsh instanceof ThreeBSP1.Node) return treeIsh;
            polygons = [];
            ...
            _fn = function(face, i) {
                ...
                if (faceVertexUvs == null) faceVertexUvs = [
                    new THREE.Vector2(),
                    new THREE.Vector2(),
                    new THREE.Vector2(),
                    new THREE.Vector2()
                ];
                polygon = new ThreeBSP1.Polygon();
                _ref2 = [
                    "a",
                    "b",
                    "c",
                ...
                for(vIndex = _j = 0, _len1 = _ref2.length; _j < _len1; vIndex = ++_j){
                    ...
                    if ((idx = face[vName]) != null) {
                        ...
                        vertex = new ThreeBSP1.Vertex(vertex.x, vertex.y, vertex.z, face.vertexNormals[0], new THREE.Vector2(faceVertexUvs[vIndex].x, faceVertexUvs[vIndex].y));
            ...
            return new ThreeBSP1.Node(polygons);
        };
        ThreeBSP1.prototype.toMesh = function(material) {
            var geometry, mesh, _this = this;
            if (material == null) material = new THREE.MeshNormalMaterial();
        ...
        ThreeBSP1.prototype.toGeometry = function() {
        ...
        ThreeBSP1.prototype.subtract = function(other) {
            var them, us, _ref;
            _ref = [
                this.tree.clone(),
                other.tree.clone()
            ], us = _ref[0], them = _ref[1];
            us.invert().clipTo(them);
            them.clipTo(us).invert().clipTo(us).invert();
            return new ThreeBSP1(us.build(them.allPolygons()).invert(), this.matrix);
        };
        ThreeBSP1.prototype.union = function(other) {
            var them, us, _ref;
            _ref = [
                this.tree.clone(),
                other.tree.clone()
            ...
            us.clipTo(them);
            them.clipTo(us).invert().clipTo(us).invert();
            return new ThreeBSP1(us.build(them.allPolygons()), this.matrix);
        };
        ThreeBSP1.prototype.intersect = function(other) {
            var them, us, _ref;
            _ref = [
                this.tree.clone(),
                other.tree.clone()
    ...
    ThreeBSP.Polygon = function() {
        ...
        Polygon.prototype.tessellate = function(poly) {
            ...
            if (this.classifySide(poly) !== SPANNING) return [
                poly
            ];
            _ref1 = poly.vertices;
            ...
            for(_i = 0, _len = _ref.length; _i < _len; _i++){
                ...
                switch(side){
                    ...
                    case BACK:
                        ...
                        break;
                    case COPLANAR:
                        if (this.normal.dot(poly.normal) > 0) _results.push(coplanar_front.push(poly));
                        else _results.push(coplanar_back.push(poly));
                        break;
                    default:
    ...
    ThreeBSP.Node = function() {
        ...
        function Node(polygons) {
            ...
            this.clone = __bind(this.clone, this);
            this.polygons = [];
            if (polygons != null && polygons.length) this.build(polygons);
        }
        Node.prototype.build = function(polygons) {
            ...
            return returning(this, function() {
                ...
                if (_this.divider == null) _this.divider = polygons[0].clone();
                ...
                for(side in sides){
                    ...
                    polys = sides[side];
                    if (polys.length) {
                        if (_this[side] == null) _this[side] = new ThreeBSP.Node();
        ...
        Node.prototype.invert = function() {
            ...
            return returning(this, function() {
                ...
                for(_j = 0, _len1 = _ref1.length; _j < _len1; _j++){
                    flipper = _ref1[_j];
                    if (flipper != null) flipper.invert();
                }
                return _ref2 = [
                    _this.back,
                    _this.front
                ], _this.front = _ref2[0], _this.back = _ref2[1], _ref2;
            });
        };
        ...
        Node.prototype.clipTo = function(node) {
            ...
            return returning(this, function() {
                ...
                if ((_ref = _this.front) != null) _ref.clipTo(node);
...
//# sourceMappingURL=index.6d42df57.js.map
